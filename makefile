...
GTK_CONFIG := -lgtk-3 -lgdk-3 -lpangocairo-1.0 -lpango-1.0 -latk-1.0 -lcairo-gobject -lcairo -lgdk_pixbuf-2.0 -lgio-2.0 -lgobject-2.0 -lglib-2.0

out/main: out/math.o out/main.o
	$(LINK) $(GTK_LIBS) -o out/main out/math.o out/main.o $(GTK_CONFIG)

out/math.o: src/math/Vector3D.cpp
	$(COMPILE) -o out/math.o src/math/Vector3D.cpp

out/main.o: src/main.cpp
	$(COMPILE) $(GTK_LIBS) -o out/main.o src/main.cpp $(GTK_CONFIG)
